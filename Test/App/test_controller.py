...
from App.DISClib.ADT import list as lt
assert pytest


@pytest.fixture
def booksfile():
    booksfile = 'Data/GoodReads/books-small.csv'
    return booksfile


@pytest.fixture
def tagsfile():
    tagsfile = 'Data/GoodReads/tags.csv'
    return tagsfile


@pytest.fixture
def booktagsfile():
    booktagsfile = 'Data/GoodReads/book_tags-small.csv'
    return booktagsfile
